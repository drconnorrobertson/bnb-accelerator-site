...
WINS = {
    "adam-s": ("Adam S.", "Sevierville, Tennessee",
                  "4.72 star rating with over 90 reviews",
                  ["4.72 stars", "90+ reviews"], "adam-s-sevierville"),
    "alfredo-and-millie": ("Alfredo &amp; Millie N.", "Sevierville, Tennessee",
                           "Guest Favorite with a 5 star rating and over $59,000 in annual revenue",
                           ["5.0 stars", "$59,000+ annual revenue", "Guest Favorite"],
                           "alfredo-millie-n-sevierville"),
    "antonio": ("Antonio", "Fort Myers, Florida",
                ...
                "antonio-fort-myers"),
    "antonio-a": ("Antonio A.", "Santa Rosa Beach, Florida",
                        "Over $172,000 in annual revenue at 51% occupancy",
                        ["$172,000+ annual revenue", "51% occupancy", "4.79 stars"], None),
    "bao-l": ("Bao L.", None, "Two Airbnbs in seven months",
               ["2 properties", "7 months"], None),
    "barry": ("Barry M.", None, "Two Airbnbs in four months",
              ["2 properties", "4 months"], None),
    "ben-f": ("Ben F.", None, "Two Airbnbs in seven months",
                    ["2 properties", "7 months"], None),
    "dr-jonathan-g": ("Dr. Jonathan G.", None,
                            "Two Airbnbs in nine months",
                            ["2 properties", "9 months"], None),
    "dr-marcos": ("Dr. Marcos N.", None, "Nineteen Airbnbs in three years",
                  ["19 properties", "3 years"], None),
    "dustin": ("Dustin W.", "Branson West, Missouri",
               "Zero vacancies from day one, launched fully booked",
               ["Fully booked at launch"], "dustin-w-branson-west"),
    ...
    "manasa-d": ("Manasa D.", None,
                        "50% occupancy with over $100,000 in annual revenue",
                        ["$100,000+ annual revenue", "50% occupancy"], None),
    "mario-s": ("Mario S.", None,
    ...
    "michael-b": ("Michael B.", None, "Two Airbnbs in five months",
                       ["2 properties", "5 months"], None),
    "mohammad-a": ("Mohammad A., PhD", None, "First Airbnb live",
                      ["First property"], None),
    ...
    "sara-o": ("Sara O.", "Panama City Beach, Florida",
    ...
    "shardul": ("Shardul", "Panama City Beach, Florida",
                ...
                "shardul-mayanka-panama-city-beach"),
...
FEATURED = ["hari-m", "murali", "antonio-a", "sara-o",
            "kenneth-m", "jason-h", "randy-l", "shardul",
            "peter-e-santa-rosa-beach", "james-b", "dr-marcos", "josiah"]
