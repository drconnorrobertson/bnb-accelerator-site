...
MAP = {
    "austin": ("texas", "Texas", "lake", "Lake house",
               [("laxman-sabitri-johnson-city", "Laxman and Sabitri, 6BR Johnson City at $680,000")],
    ...
    "destin": ("florida", "Florida", "beach", "Beach property",
               [("mark-farrah-destin", "Mark and Farrah, 4BR Destin at $950,000"),
                ("tiffany-destin", "Tiffany, 5BR Destin at $1,100,000"),
                ("ashley-billy-fort-walton-beach", "Ashley and Billy, 80 nights in 21 days")],
    ...
    "gatlinburg": ("tennessee", "Tennessee", "mountain", "Mountain cabin",
                   [("victoria-sevierville", "Victoria, 9BR cabin, $20,000 in June")],
    ...
    "kissimmee": ("florida", "Florida", "beach", "Beach property",
                  [("jason-marissa-champions-gate", "Jason and Marissa, 8BR at $650,000"),
                   ("naveen-davenport", "Naveen, 8BR Davenport at $700,000")],
    ...
    "nashville": ("tennessee", "Tennessee", "city", "City rental",
                  [("mahmoud-nashville", "Mahmoud, 4BR permitted Nashville STR"),
                   ("krystin-michael-nashville", "Krystin and Michael, 4BR Nashville")],
                  [("nashville-permit-value", "What a Nashville permit is actually worth")]),
    "panama-city-beach": ("florida", "Florida", "beach", "Beach property",
                          [("shardul-mayanka-panama-city-beach", "Shardul and Mayanka, 4BR at $530,000")],
    ...
    "poconos": ("pennsylvania", "Pennsylvania", "lake", "Lake house",
                [("julie-pocono-lake", "Julie, 5BR Pocono Lake at $880,000")],
    ...
    "smoky-mountains": ("tennessee", "Tennessee", "mountain", "Mountain cabin",
                        [("victoria-sevierville", "Victoria, 9BR cabin, $20,000 in June"),
                         ("vishal-sevierville", "Vishal, 5BR at $1,250,000"),
                         ("alfredo-millie-n-sevierville", "Alfredo and Millie, 4BR at $865,000"),
                         ("adam-s-sevierville", "Adam, 4BR at $775,000")],
                        [("smoky-mountains-submarket-differences", "The three submarkets compared")]),
}


def landings(slug):
    """Every case study landing page transacted in this market, from the
    generator rather than a hand-kept list, so a new deal links itself in."""
    import case_studies
    out = []
    for r in case_studies.records():
        if r["market_slug"] != slug:
            continue
        out.append((r["slug"], case_studies.label(r)))
    return out
